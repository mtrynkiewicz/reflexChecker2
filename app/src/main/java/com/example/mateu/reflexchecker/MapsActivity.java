...
import static com.example.mateu.reflexchecker.R.id.map;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng niedrzwica = new LatLng(0, 0);
        mMap.addMarker(new MarkerOptions().position(niedrzwica).title("Marker in 0"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(niedrzwica));
